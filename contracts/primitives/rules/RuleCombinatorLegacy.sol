...
abstract contract RuleCombinatorLegacy is IRule {
    ...
    event Lens_RuleCombinator_RuleAdded(address indexed contractAddress, bytes data);
    ...
    function _initialize(bytes memory operationData) internal virtual {
        ...
        (CombinationMode combinationMode, address accessControl, bytes memory addRulesData) =
